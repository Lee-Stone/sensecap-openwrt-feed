...
return view.extend({
    view: function () {
        ...
        // Safely get server value from lorawan-gateway config and set it directly
        var radioSection = uci.sections("lorawan-gateway", "radio")[0];
        var serverValue = radioSection ? uci.get('lorawan-gateway', radioSection['.name'], 'server') : '';
